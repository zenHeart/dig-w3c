# CANVAS 使用手册
**前言：** 讲解 CANVAS 的 API 使用

## CANVAS 的介绍
CANVAS 是 W3C 推出的基于 JS 画图的 API ,可以用来实现 2 位的基本图像绘制，
并结合这些基本的画图 API 实现你所需要的复杂图形效果，可以用在 HTML5 的游戏制作，
图表绘制等多方面。
...
<tbody>
  ...
  <tr>
    <td>getContext('2d')</td>
    <td>获取 context 对象，这个对象上拥有绘图的 API,以后 W3C 可能会更改为 3d 的获取</td>
  </tr>
  <tr>
    <td>toDataURL()</td>
